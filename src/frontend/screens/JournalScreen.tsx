...
const journalPrompts = [
  ...
  "What challenge are you currently facing, and how might you approach it?",
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.promptSection}>
          ...
          >
            ...
            <Text style={styles.promptButtonText}>Get Writing Prompt</Text>
            <Ionicons
        ...
        <View style={styles.recentEntries}>
          ...
          <TouchableOpacity style={styles.entryCard} activeOpacity={0.8}>
            ...
            <Text style={styles.entryCardPreview} numberOfLines={2}>
              I've been thinking about how to better manage stress at work. Some strategies that might help...
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.entryCard} activeOpacity={0.8}>
            ...
            <Text style={styles.entryCardPreview} numberOfLines={2}>
              Had a wonderful conversation with a friend today. It reminded me of the importance of connection...
            </Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
